...
function startButtonListeners() {
  ...
  document.getElementById('add-dest').addEventListener('click', function() {
    ...
    new_dest_field.innerHTML = '<input type="text" class="send-input-dest" id="send-dest-'+i+'" placeholder="Enter destination address"><img class="send-contact-icon" id="send-contact-'+i+'">';
